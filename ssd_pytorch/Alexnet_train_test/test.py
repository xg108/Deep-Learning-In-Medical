...
test_dataset = torchvision.datasets.ImageFolder(root='data/duibi/phone', transform=transform)
...
for data in test_loader:  # 循环每一个batch
    ...
    if classes[labels[0]] == '1' and classes[predicted[0]] == '1':
        TP = TP + 1
    # f.write('{:s} {:s}\n'.format(classes[labels[0]], str(out[0][1])))
