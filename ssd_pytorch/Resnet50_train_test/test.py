...
test_dataset = torchvision.datasets.ImageFolder(root='data/duibi/cam', transform=transform)
...
checkpoint = torch.load('Resnet5.17-50_params.pkl')
...
FP = 0
TN = 0
f = open("5.17-2/cam_resnet.txt", "w")
for data in test_loader:  # 循环每一个batch
    images, labels = data
    # print(test_loader.imgs)
